...
function cargarListaProductos(){
    ...
    listaProductos.push(new Producto(objeto));
    //esta carga quedo un poco desprolija pero lo hice asi para poder incorporar la desestructuracion en parametros para este desafio
...
function verCarrito(carrito){
    ...
    carrito.productos.length === 0 && (containerCarrito.innerHTML+= `<p>El carrito esta vacio.</p>`);
