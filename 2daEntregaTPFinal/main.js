//2DA ENTREGA TP FINAL - ROBLEDO, BELEN
...
function cargarListaProductos(){
    let listaProductos = [];
    listaProductos.push(new Producto("Jugo", 120, "Bebida", "/img/jugo.jpg"));
    listaProductos.push(new Producto("Gaseosa", 230, "Bebida", "/img/gaseosa.jpg"));
    listaProductos.push(new Producto("Vino", 490, "Bebida", "/img/vino.jpg"));
    listaProductos.push(new Producto("Galletitas", 170, "Comida", "/img/galletitas.jpg"));
    listaProductos.push(new Producto("Nachos", 150, "Comida", "/img/nachos.jpg"));
    listaProductos.push(new Producto("Chocolate", 95, "Comida", "/img/chocolate.jpg"));
...
function mostrarCantidadEnProducto(carrito){
    for(const producto of carrito.productos){
        ...
        column.innerHTML += `<p class="card-text">Cantidad: <b>${producto.cantidad}</b></p>`;
    }
}
//----------------------------------------------------------------------------------------------------------
...
function retrieveCarrito(){
    ...
    if(listaJSON!=null){
        for(const objeto of listaJSON){
            let producto = new Producto(objeto.nombre, objeto.precio, objeto.categoria);
